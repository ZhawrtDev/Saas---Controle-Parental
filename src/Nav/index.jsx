  ...
  return (
    <>
      <div className="nav-top">
        ...
        <div className="second-content">
          ...
          <div className="s2">
            ...
            onClick={() => setActiveComponent({ name: "apkdownload" })}
            >
              <FontAwesomeIcon
                icon={faDownload}
                color="#B9B9BB"
          ...
          <div className="box-arrow">
            ...
            <div className="boxs">
              <div
                className="box a"
                onClick={() =>
                  setActiveComponent({ name: "aphones", type: "all" })
                }
              >
                <p>All</p>
              ...
              <div
                className="box"
                onClick={() =>
                  setActiveComponent({ name: "aphones", type: "online" })
                }
              >
                <p>Online</p>
              ...
              <div
                className="box"
                onClick={() =>
                  setActiveComponent({ name: "aphones", type: "offline" })
                }
              >
                <p>Offline</p>
      ...
      <div className={`render-nav ${isActive ? "a" : ""}`}>
        {activeComponent.name === "aphones" && (
          <Aphones type={activeComponent.type || "all"} />
        )}
